    ...
    return (
      ...
      >
        <List className="list_item" loading={this.state.isLoading}>
          <Item>
            <span className="prod_title">员工姓名：</span> 
            <span >{this.state.name}</span>
          </Item>
          <Item>
            <span className="prod_title">座右铭：</span> 
            <span>{this.state.desc}</span>
          </Item>
          <Item> 
            <span className="prod_title">员工工资：</span>
            <span>{this.state.price}</span>  
          </Item>
          <Item>
            <span className="prod_title">所属部门：</span> 
            <span>{this.state.categoryName}</span>
          </Item>
          <Item>
            <span className="prod_title">员工图片：</span>
            {
          ...
          <Item>
            <span className="prod_title">员工信息：</span> 
