  ...
  render(){
    ...
    const title = ( 
      <div>
        ...
        <span>{operaType==='add'? '添加员工信息':'修改员工信息'}</span>
      </div>
    )
    ...
    return (
      <Card title={title}>
        <Form {...formItemLayout} onSubmit={this.handleSubmit} >
          ...
          <Item label="座右铭" >
            {
              getFieldDecorator('desc', {
                ...
                <Input placeholder="座右铭" allowClear/>
              )}
          </Item>
          <Item label="员工">
            {
              getFieldDecorator('price', {
                ...
                rules: [{required: true, message: '请输入员工工资'}]
              })(
                <Input 
                  placeholder="员工工资"
                  addonAfter="元"
          ...
          <Item label="员工图片" wrapperCol={{md:10}}>
            <PicturesWall ref="pictureWall"/>
          </Item>
          <Item label="员工信息" wrapperCol={{md:15}}>
